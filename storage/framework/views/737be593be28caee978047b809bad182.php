...
<?php endif; ?>
    ...
    <?php if (! $__env->hasRenderedOnce('c5ea55ff-5fd0-44a8-aa31-8ff7e387e92f')): $__env->markAsRenderedOnce('c5ea55ff-5fd0-44a8-aa31-8ff7e387e92f');
                                ...
                                <div class="mt-5 grid gap-2" style="grid-template-columns: auto 1fr;">
                                    <?php $__currentLoopData = $customAttributeValues; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $customAttributeValue): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <?php if(! empty($customAttributeValue['value'])): ?>
                                            <p class="text-sm text-zinc-500" v-pre><?php echo e($customAttributeValue['label']); ?></p>
                                            ...
                                            <?php else: ?>
                                                <p class="text-sm text-zinc-500" v-pre><?php echo e($customAttributeValue['value'] ?? '-'); ?></p>
                                            <?php endif; ?>
                                        <?php endif; ?>
                                                ...
                                                <?php $__currentLoopData = $customAttributeValues; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $customAttributeValue): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <?php if(! empty($customAttributeValue['value'])): ?>
                                                        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 8px;">
                                                            <p style="font-size: 14px; color: #666;"><?php echo $customAttributeValue['label']; ?></p>
                                                            <p style="font-size: 14px; color: #1a1a1a;"><?php echo $customAttributeValue['value']; ?></p>
                                                        </div>
                                                    <?php endif; ?>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </div>
...
<?php endif; ?>
<?php /**PATH D:\Frooxi new\Iqbal Project\NextOutfit\packages\Webkul\Shop\src/resources/views/products/view.blade.php ENDPATH**/ ?>